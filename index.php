                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">Rp.<?= $pemasukan_hari_ini ? number_format($pemasukan_hari_ini['0'],2,',','.') : '0';?></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">Rp.<?= $pengeluaran_hari_ini ? number_format($pengeluaran_hari_ini['0'],2,',','.') : '0';?></div>
                    </div>
                    <div class="col-auto">
